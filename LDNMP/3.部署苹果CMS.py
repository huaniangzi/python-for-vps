...
def update_server(name, hostname, port, username, password, domain, dbrootpasswd, dbuse, dbname ):
    try:
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/conf.d/' + domain + '.conf https://raw.githubusercontent.com/kejilion/nginx/main/maccms.com.conf && \
        ...
        command = (
            ...
            'cd /home/web/html/{}/maccms10-master/template/ && wget https://github.com/kejilion/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/{}/maccms10-master/template/DYXS2.zip && '
            'cp /home/web/html/{}/maccms10-master/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/{}/maccms10-master/application/admin/controller &&'
            'cp /home/web/html/{}/maccms10-master/template/DYXS2/asset/admin/dycms.html /home/web/html/{}/maccms10-master/application/admin/view/system &&'
            'mv /home/web/html/{}/maccms10-master/admin.php /home/web/html/{}/maccms10-master/vip.php && wget -O /home/web/html/{}/maccms10-master/application/extra/maccms.php https://raw.githubusercontent.com/kejilion/Website_source_code/main/maccms.php'

        ).format(domain, domain, domain, domain, domain, domain, domain, domain, domain, domain, domain)
        ...
        stdin, stdout, stderr = client.exec_command("echo \"define('FS_METHOD', 'direct'); define('WP_REDIS_HOST', 'redis'); define('WP_REDIS_PORT', '6379');\" >> /home/web/html/{}/wordpress/wp-config-sample.php".format(domain))
        stdout.channel.recv_exit_status()  # 等待命令执行完成
